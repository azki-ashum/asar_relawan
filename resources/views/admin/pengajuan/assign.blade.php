                ...
                <div class="mb-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="flex-grow-1">
                            <select name="relawan_id" class="form-select form-select-sm relawan-select" placeholder="-- Pilih --">
                        ...
                        <button type="submit" class="btn btn-success flex-shrink-0 d-inline-flex align-items-center justify-content-center" disabled style="height: 40px; padding: 0 1.25rem; border-radius: 12px; font-weight: 600;"><i class="bi bi-check-lg me-1"></i>Tugaskan</button>
                    </div>
                    @if($candidates[$k->id]->isEmpty())
                        <div class="form-text text-danger mt-1">Tidak ada relawan tersedia untuk jenis ini. <a href="{{ route('admin.relawan.create') }}">Tambah relawan baru</a>.</div>
                    @endif
                </div>
