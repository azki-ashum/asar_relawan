...
<head>
    ...
    <style>
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 .22rem rgba(22, 163, 74, .14);
        }
        ...
        .stat-card .bi.text-primary {
            background: #eef2ff;
        }

        .stat-card .bi.text-info {
            background: #e0f2fe;
        }

        .stat-card .bi.text-warning {
            background: #fef3c7;
        }

        .stat-card .bi.text-success {
            background: #dcfce7;
        }
        ...
        /* ---- Global Icon & Alignment Fixes ----
           Bootstrap Icons sudah memberi offset vertical-align pada ::before.
           Bila wrapper <i> juga diberi offset, ikon turun dua kali lipat dan
           terlihat tidak sejajar. Offset dipusatkan hanya pada wrapper. */
        .bi {
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        /* Komponen yang kerap berisi ikon + teks: ratakan lewat flexbox
           sehingga tidak bergantung pada baseline font. */
        .btn,
        .badge,
        .nav-link,
        .input-group-text,
        ...
        /* Ikon sebagai flex item: perataan diurus induknya, matikan offset baseline. */
        .btn>.bi,
        .badge>.bi,
        .nav-link>.bi,
        .dropdown-item>.bi,
        ...
        /* Judul kartu yang diawali ikon tetap sejajar dengan teksnya. */
        .card-header h5>.bi,
        .card-header h6>.bi,
        .form-label>.bi {
            vertical-align: -0.125em;
        ...
        /* Alert non-flex: ikon di awal baris tetap sebaris dengan teks. */
        ...
        /* izinkan flex child menyusut agar badge tak mendorong overflow */
        .page-header h3 {
            font-size: 1.4rem;
            line-height: 1.3;
        }
        ...
        @media (max-width: 767.98px) {
            ...
            .table-stack tbody td+td:not(.cell-actions) {
            ...
            .table-stack tbody td.cell-title {
                display: block;
                text-align: left;
                padding: .95rem 1.05rem .8rem !important;
                font-weight: 700;
                font-size: 1.06rem;
                line-height: 1.3;
                color: var(--ink);
            ...
            .table-stack tbody td.cell-title::before {
                display: none;
            }

            .table-stack tbody td.cell-title .small {
                font-weight: 500;
            }
            ...
            .table-stack tbody td.cell-actions::before {
                display: none;
            }

            .table-stack tbody td.cell-actions .btn {
                width: 100%;
            }
            ...
            .table-stack tbody tr.no-card td {
                display: block;
                text-align: center;
            }

            .table-stack tbody tr.no-card td::before {
                display: none;
            }
        }
        ...
        @media (max-width: 575.98px) {
            ...
            .sop-timeline .step-circle {
                width: 34px !important;
                height: 34px !important;
                font-size: .8rem !important;
            }

            .sop-timeline .step-label {
                font-size: .68rem !important;
            }

            .sop-timeline .step-line {
                top: 16px !important;
            }
        }
    </style>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.pengajuan.*') ? 'active fw-semibold' : '' }}"
                            href="{{ route('admin.pengajuan.index') }}">
                            <i class="bi bi-inboxes me-1"></i>Pengajuan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.relawan.*') ? 'active fw-semibold' : '' }}"
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('relawan.dashboard') ? 'active fw-semibold' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pengajuan.create') ? 'active fw-semibold' : '' }}"
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="{{ $isAdminArea ? route('relawan.dashboard') : route('admin.pengajuan.index') }}">
                            <i class="bi bi-arrow-left-right me-1"></i>{{ $isAdminArea ? 'Mode Pengaju' : 'Mode Admin'
                            }}
                        </a>
                    </li>
                    @endif
                    @php $initial = \Illuminate\Support\Str::of($u->name ?: $u->email)->trim()->substr(0,1)->upper();
                    @endphp
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" id="userMenu"
                            ...
                            <span class="text-truncate" style="max-width:160px;">{{ $u->name ?
                                \Illuminate\Support\Str::title($u->name) : $u->email }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu" style="min-width:220px;">
                            <li class="px-2 py-1">
                                <div class="fw-semibold text-truncate">{{ $u->name ?
                                    \Illuminate\Support\Str::title($u->name) : '—' }}</div>
